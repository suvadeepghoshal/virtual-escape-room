      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <div className='space-y-12'>
              ...
              <div className='sm:col-span-4'>
                ...
                <div className='mt-2'>
                  <input
                    id='name'
                    {...register('room_name', {
                      required: 'Title of the room is required',
                    })}
                    type='text'
          ...
          <div className='border-b border-gray-900/10 dark:border-gray-200/10 pb-12'>
            <h2 className='text-base font-semibold leading-7 text-gray-900 dark:text-gray-200'>
              Other required information about the room
            </h2>
            ...
            <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
              ...
              <div className='sm:col-span-2 sm:col-start-1'>
                ...
                <div className='mt-2'>
                  <input
                    type='text'
                    {...register('room_maxTimeLimit', {
                      required: 'Solve time can not be 0 seconds',
                    })}
                    id='maxTimeLimit'
                  ...
                  {errors.room_maxTimeLimit && (
                    <p className='mt-2 text-sm text-red-600 dark:text-red-500'>
                      {errors.room_maxTimeLimit.message}
                    </p>
                  )}
                </div>
              </div>
          ...
          <div className='border-b border-gray-900/10 dark:border-gray-200/10 pb-12'>
            ...
            <p className='mt-1 text-sm leading-6 text-gray-600'>
              Great start, Creator! 🚀 You&apos;re about to craft an
              unforgettable adventure. The escape room you&apos;re creating will
              transport players to a world of intrigue and challenge. Remember,
              every puzzle you design adds a layer of excitement. Describe the
              room with vivid detail, and let your creativity soar! Happy
              crafting!
            </p>
          </div>
        </div>
        ...
        <div className='mt-6 flex items-center justify-end gap-x-6'>
          <Link
            className='text-sm font-semibold leading-6 text-gray-900 dark:text-gray-200 hover:underline'
            href={'/'}
          >
            Cancel
          </Link>
